...
Date: 11/18/2017
Purpose: https://developers.google.com/edu/c++/getting-started exercise 7 Modified version
...
//function prototype
int GetInput();
int returnFirstNum(int);
int returnSecondNum(int);
int returnThirdNum(int);
int GetABC(int, int, int);
int GetBCA(int, int, int);
int GetCAB(int, int, int);
int GModABC(int);
int GModBCA(int);
int GModCAB(int);
int Gaddxy(int, int);
